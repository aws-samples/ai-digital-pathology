...
cp ../train/hoptimus_model_backbone.py preprocessing-code/hoptimus_model_backbone.py
echo "backbone model copied to code folder"
...
rm preprocessing-code/hoptimus_model_backbone.py
echo "Cleaning process completed, image built"
